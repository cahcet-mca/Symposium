...
const EventDetailsPopup = ({ event, onClose, registrationsOpen = true }) => {
    ...
    const fetchEventData = async () => {
      try {
        ...
        if (response.data.success) {
          ...
          const registered = latestEvent.confirmedCount || latestEvent.registeredCount || 0;
          const waitlist = latestEvent.pendingCount || 0;
  ...
  const getStatusText = () => {
    if (isEventFull()) return 'Event Full - Waitlist Available';
              ...
              <div className="status-card">
                ...
                <div className="stats-grid-4">
                  ...
                  <div className="stat-box">
                    ...
                    <span className="stat-value waitlist">{registrationStats.waitlistCount}</span>
                  </div>
                  <div className="stat-box">
          ...
          <div className="popup-section">
            ...
            <div className="info-grid">
              ...
              <div className="info-item">
                ...
                <span className="info-value">{symposiumDate}</span>
              </div>
              <div className="info-item">
