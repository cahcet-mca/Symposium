  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setIsWaitlistRegistration(response.data.registration?.isWaitlisted || false);
        setSuccessMessage(response.data.message || 'Payment verified successfully!');
        setError('');
                ...
                <div className="success-message">
                  ...
                  <div>
                    ...
                    {isWaitlistRegistration && (
                      <p style={{ fontSize: '0.9rem', marginTop: '5px', color: '#ffa502' }}>
