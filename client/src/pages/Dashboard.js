      ...
      <body>
        <div class="ticket">
          ...
          <div class="footer">
            ...
            <p style="color: #ffd700; margin-top: 10px;">✨ TRIBYTE 2026 - Think Big • Act Smart • Win Together ✨</p>
          </div>
        </div>
      </body>
      </html>
            ...
            <div className="profile-stats">
              ...
              <div className="stat-item">
                <span className="stat-value">
                  {registeredEvents.filter(e => e.teamName && e.teamName !== 'Individual').length}
                </span>
                  ...
                  {registeredEvents.map((registration) => (
                    <div key={registration._id} className="registration-card">
                      <div className="registration-header">
                        <span className={`event-status ${registration.registrationStatus?.toLowerCase()}`}>
