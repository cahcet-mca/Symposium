...
const UPIPayment = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.transactionId.trim().length < 10) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const requestData = {
        ...
        // User details for Google Sheets
        user: {
          name: user?.name || '',
          email: user?.email || '',
          phone: user?.phone || '',
          ...
          <form onSubmit={handleSubmit} className="payment-form">
            ...
            <div className="form-section payment-section">
              ...
              <div className="qr-container">
                <img 
                  src={`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=upi://pay?pa=${merchantUPI}&pn=TRIBYTE2026&am=${totalAmount}&cu=INR`}
                  alt="UPI QR Code"
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src = 'https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=TRIBYTE2026';
                  }}
                />
              ...
              <div className="payment-steps">
                ...
                <ol>
                  ...
                  <li>Enter transaction ID below and upload screenshot</li>
                </ol>
              </div>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  required
                />
                <small className="field-note">Enter the transaction ID from your UPI app (min. 10 characters)</small>
              </div>
              ...
              {verificationStatus === 'success' && (
                <div className="success-message">
                  ...
                  <div>
                    ...
                    <p>Your registration is confirmed. Redirecting to dashboard...</p>
                  </div>
                </div>
              )}
