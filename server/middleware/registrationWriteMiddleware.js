...
const checkRegistrationsOpenForWrite = async (req, res, next) => {
  try {
    ...
    // Check if registrations are open for write operations
...
module.exports = { checkRegistrationsOpenForWrite };